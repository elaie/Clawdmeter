...
// 20x20 grid scaled 24x to fill 480x480 canvas. On the 466-round panel the
// canvas overflows the display by 7px on each side; the round bezel masks
// the clip naturally. Revisit in task 8 if a tighter fit is needed.
#define GRID         20
#define CELL         24
